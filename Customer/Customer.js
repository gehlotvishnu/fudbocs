               ...
               <tbody>                 
                {
                  ...
                  return <tr>
                          ...
                          <td>
                            <div>
                                <input type='button' name='Edit' id={`Edit_${index}`} value='Edit Customer' onClick={()  => that.props.openEditCustDialog(customer.id)} />
                                &nbsp;<input type='button' name='schedule' id={`Schedule_${index}`} value='Schedule' onClick={()  => that.props.openScheduleDialog(customer.id, customer.name)}/>
